...
public final class LocationListenerService extends Service {
    ...
    private static final String NOTIFICATION_CHANNEL = "TreesappLocation";
    ...
    public static final String UPDATE_ACTION = "LocationUpdate";

    /** The name of the Intent extra data item that holds the new location. */
    public static final String UPDATE_DATA_ID = "Location";
